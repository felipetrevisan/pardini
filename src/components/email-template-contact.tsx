...
import { Body, Container, Head, Heading, Html, Img, Text, Tailwind } from "@react-email/components";

export function EmailTemplateContact({ name, subject, message }: ContactFormSchema) {
  return (
    <Tailwind>
      <Html>
        <Head />
