						...
						<Carousel>
							<CarouselContent>
								<CarouselItem className="basis-1/2 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
									...
									>
										<p>
											...
											você encontre a certidão de nascimento do seu antepassado
											italiano e inicie o seu processo de reconhecimento da
											cidadania.
										</p>
									</Item>
								</CarouselItem>
								<CarouselItem className="basis-1/2 md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
									...
									>
										<p>
											Tudo o que você precisa saber sobre a cidadania italiana e
											os requisitos para iniciar o seu processo.
										</p>
										<p>
											Com este e-book você vai entender as vantagens, as formas
											que você tem de reconhecer a cidadania italiana e ter
