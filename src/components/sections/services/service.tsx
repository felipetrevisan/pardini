  ...
  return (
    <Tabs defaultValue="dont-have-citizenship">
      <TabsList className="grid w-full grid-cols-1 md:grid-cols-2">
        <TabsTrigger value="dont-have-citizenship">Ainda não tenho cidadania</TabsTrigger>
        <TabsTrigger value="already-have-citizenship">Já tenho cidadania</TabsTrigger>
      </TabsList>
